...
import 'package:sixam_mart_delivery/features/order/screens/qr_code.dart';
                      ...
                      showDeliveryConfirmImage &&
                          ...
                          : showBottomView
                              ? ((accepted! &&
                                  ...
                                  : showSlider
                                      ? ((cod && accepted && !restConfModel && cancelPermission! && !selfDelivery) || (parcel && accepted && cancelPermission!))
                                          ? Row(children: [
                                              Expanded(
                                                  child: TextButton(
                                                onPressed: () {
